...
public class NewYorkCompany1 {
	...
	public static void main(String[] args) throws Throwable  {
		...
		if(valueGU==true)
		{
			System.out.println("Test Case is Passed for isdisplayed : " + valueGU);
		}
		else
		{
			System.out.println("Test Case is Failed for isdisplayed : " + valueGU);
		}
